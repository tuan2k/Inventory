...
<head>
    ...
    <title>Easy Learning Inventory - Dashboard</title>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrap27"
               aria-expanded="true" aria-controls="collapseBootstrap27">
                <i class="far fa-fw fa-window-maximize"></i>
                <span>User</span>
            </a>
            <div id="collapseBootstrap27" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <router-link to="/store-user" class="collapse-item">Add User</router-link>
                    <router-link to="/user" class="collapse-item">All User</router-link>
                </div>
            </div>
        </li>
        <li class="nav-item">
            ...
            <div id="collapseBootstrap17" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <router-link to="/store-role" class="collapse-item">Add Role</router-link>
                    <router-link to="/role" class="collapse-item">All Role</router-link>
                </div>
            </div>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <div id="collapseBootstrap6" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <router-link to="/give-salary" class="collapse-item">Add Salary</router-link>
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                           aria-haspopup="true" aria-expanded="false">
                            ...
                            <router-link to="/logout" class="ml-2 d-none d-lg-inline text-white small">Maman Ketoprak</router-link>
                        </a>
