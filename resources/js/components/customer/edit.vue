<template>
    <div>
        <div class="row">
            <router-link to="/customer" class="btn btn-primary">Update Customer</router-link>
        </div>
                                    ...
                                    <form class="user" @submit.prevent="customerUpdate" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" v-model="form.phone" class="form-control" id="exampleInputSalary" placeholder="Enter Your Phone">
